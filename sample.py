...
out_dir = 'Eml2b_hl' # ignored if init_from is not 'resume'
start = "We have been invaded, and successfully repelled the raiders. \nWhat do we do with raiders we caught?\n" # or "<|endoftext|>" or etc. Can also specify a file, use as: "FILE:prompt.txt"
num_samples = 3 # number of samples to draw
max_new_tokens = 515 # number of tokens generated in each sample
